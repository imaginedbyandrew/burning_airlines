...
class SeatsControllerTest < ActionController::TestCase
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post :create, seat: { flight_id: @seat.flight_id, name: @seat.name, passenger_id: @seat.passenger_id }
    end
  ...
  test "should update seat" do
    patch :update, id: @seat, seat: { flight_id: @seat.flight_id, name: @seat.name, passenger_id: @seat.passenger_id }
    assert_redirected_to seat_path(assigns(:seat))
  end
